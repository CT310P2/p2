                    ...
                    <form method="POST" action="check">
                        <div class="card text-center border-danger w-50 mx-auto">
                            ...
                            <div class="card-body">
                                ...
                                <div class="form-row">
                                    <div class="form-group col">
                                        <input type="text" class="form-control" aria-describedby="email" placeholder="Email" name="email"/>
                                    </div>
                                </div>
                                <button type="submit" class="btn btn-outline-danger my-2 my-sm-0" name="signup" value="signup">Sign Up</button>
                            </div>
                            <div class="card-footer text-muted">
